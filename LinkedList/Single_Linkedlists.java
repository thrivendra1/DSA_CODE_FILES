...
public class Single_Linkedlists {
...
//        Node Nu=Deleting_a_number(head,5); // removing a number
...
//                return temp.data;
    ...
    //-> 4.------------------------------- deleting a Deleting_a_number  in LinkedList---------------------------------------

    static public Node Deleting_a_number(Node head,int k)
    {
        if(head==null) return head;
        int count=0;
        int num=head.data;
